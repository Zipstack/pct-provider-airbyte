...
type destinationPostgresResourceModel struct {
	...
	ConnectionConfiguration destPostgresConnConfig `json:"connectionConfiguration"`
}
...
type destPostgresConnConfig struct {
	...
	Ssl           bool                               `json:"ssl"`
	SslMode       destPostgresConnConfigSslMode      `json:"ssl_mode"`
	TunnelMethod  destPostgresConnConfigTunnelMethod `json:"tunnel_method"`
...
type destPostgresConnConfigSslMode struct {
	...
	ClientKeyPassword string `json:"client_key_password"`
}
...
type destPostgresConnConfigTunnelMethod struct {
	...
	TunnelUser_password string `json:"tunnel_user_password"`
}
